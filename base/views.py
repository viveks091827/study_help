...
#     {'id' : 2, 'name' : 'learn java script'},
#     {'id' : 3, 'name' : 'learn frontend development'},
#     {'id' : 4, 'name' : 'learn backend development'}
# ]
...
def register_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'An erro occurred during registration')
